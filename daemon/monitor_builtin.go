...
// newbuiltinMonitor returns an initialized containerMonitor for the provided container
// honoring the provided restart policy
func newBuiltinMonitor(container *Container, policy runconfig.RestartPolicy) *builtinMonitor {
...
func (m builtinMonitor) ExitOnNext() {
	m.mux.Lock()
...
func (m builtinMonitor) Close() error {
...
func (m builtinMonitor) Start() error {
	var (
		err        error
...
// resetMonitor resets the stateful fields on the builtinMonitor based on the
...
func (m builtinMonitor) resetMonitor(successful bool) {
...
func (m builtinMonitor) waitForNextRestart() {
	select {
...
func (m builtinMonitor) shouldRestart(exitCode int) bool {
	m.mux.Lock()
	defer m.mux.Unlock()
...
func (m builtinMonitor) callback(processConfig *execdriver.ProcessConfig, pid int) {
...
func (m builtinMonitor) resetContainer(lock bool) {
